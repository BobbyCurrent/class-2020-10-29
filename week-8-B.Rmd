...
$$att_{chg} = \beta_{int} + \beta_1 x_{treatment} + \epsilon_i$$

* Describe the ideal Preceptor Table.
The ideal preceptor table would have no unkowns and would have the values for people both with and without the treatment, so that the changge in attitude could be accurately seen.

* Write a few sentences about whether or not our data will allow us to answer this question.
It can be helpful in some ways I guess. It will allow us to see the affect the treatment had on attitude in the study.
